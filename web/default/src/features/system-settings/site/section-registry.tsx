...
import { CustomNavItemsSection } from '../maintenance/custom-nav-items-section'
...
const SITE_SECTIONS = [
  ...
  {
    id: 'custom-nav-items',
    titleKey: 'Custom navigation items',
    build: (settings: SiteSettings) => (
      <CustomNavItemsSection data={settings.CustomNavItems ?? ''} />
    ),
  },
] as const
